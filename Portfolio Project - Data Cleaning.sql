...
-- Crypto has multiple different variations. We need to correct that
SELECT DISTINCT industry
FROM world_layoffs.layoffs_staging2
ORDER BY industry;
...
-- We have some "United States" and some "United States." with a period at the end. Let's correct this.
